...
Uso:
    ...
    python3 merge_ejemplos.py        # regenera v2/ejemplos/*.json con las tipologias nuevas
"""
import glob
import json
import os
...
def actualizar_catalogo(descripciones):
    ...
    nota = (
        ...
        "palabra). Ver `v2/libro_pipeline/clasificar_otros.py` para el criterio de asignación."
    )
...
def main():
    ...
    print("\n✅ listo -- corre merge_ejemplos.py para regenerar v2/ejemplos/*.json")
